...
java -jar Sender/target/Sender.jar unmappable | poison | flaky | slow | burst 20
```
...
| `SimpleMessaging/src/main/java/simplemessaging/Channel.java` | the topology, drawn in a comment. Read it |
| `SimpleMessaging/src/main/java/simplemessaging/MessagePump.java` | **the one file you need to change** |
