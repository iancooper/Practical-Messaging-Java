...
public class DataTypeChannelConsumer<T extends IAmAMessage> implements AutoCloseable {
    ...
    private static final String EXCHANGE_NAME = "polling-practical-messaging";
    private static final String INVALID_EXCHANGE_NAME = "polling-practical-messaging-invalid";
