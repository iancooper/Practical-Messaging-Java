...
/**
 * Somewhere to put a fact that has happened. The handler depends on this and not on Kafka, which is
 * the same separation the Message Mapper bought on the way in.
 * <p>
 * <b>That separation does not save you here, and it is important to see why.</b> The handler is
 ...
 */
public interface IPublishEvents<T extends IAmAMessage> {
